...
{
    public partial class InitialMemberCreate : Migration
    {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumber = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SecondaryPhoneNumber = table.Column<string>(type: "varchar", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    Occupation = table.Column<string>(type: "varchar", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Photo = table.Column<string>(type: "varchar", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    ChurchRole = table.Column<int>(type: "int", nullable: false),
